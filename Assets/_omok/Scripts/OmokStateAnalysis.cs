...
public class OmokStateAnalysis {
	...
	public void PieceAnalysisTest(Coord coord, OmokState.UnitState unitState) {
		bool isPlayerPiece = false;
		byte player = 0;
		switch (unitState) {
			case OmokState.UnitState.Player0: player = 0; isPlayerPiece = true; break;
			case OmokState.UnitState.Player1: player = 1; isPlayerPiece = true; break;
		}
		if (!isPlayerPiece) {
			return;
		}
	...
	public void PieceAnalysis(Coord coord, OmokState.UnitState unitState) {
		bool isPlayerPiece = false;
		byte player = 0;
		switch (unitState) {
			case OmokState.UnitState.Player0: player = 0; isPlayerPiece = true; break;
